...
//#define invalid_pte_table (0x80100000 + 4096)
...
//#define swapper_pg_dir (0x80100000 + 0)

extern void paging_init(void);

extern void __update_tlb(struct vm_area_struct *vma, unsigned long address, pte_t pte);
extern void __update_cache(struct vm_area_struct *vma, unsigned long address, pte_t pte);
